...
<td>Post interview rejection</td>

<td>Accepted without funding</td>

<td>Accepted with funding</td>
...
<td>Withdrew post interview</td>

<td>Failed funding application</td>
...
<td>Rejected pre interview</td>

<td>Failing funding application</td>
...
<td>Funding rejected pre interview</td>
...
3.  Be curious. Academia has been very ‘small world’ in my experience. Read that random article someone sent you. It could become the thing you end up becoming interested in. A good friend of mine sent me a random article before I started uni which his older brother had told him about. This article defines much of the research I’m currently interested (and pursuing a PhD in) to this day.

## The importance of research experience {#importance}

If you’re still thinking about academia after this - get some research experience. Just do it. I cannot stress this enough. I’ve worked loads of jobs, and trust me, there’s nothing quite like academia. This is something you want to do to see if you like it, you won’t know what it’s like until you try. In and outside of academia, experience can often be a thorn in your side when applying for positions. Don’t treat it as a hoop to jump through, treat it as an opportunity. Here are some more reasons why you should:
...
I should note here that a lack of experience does not mean you won’t make a good researcher. Your ability is just as easily not evidenced without experience. But having experience can make it easier/more concrete for people to see how good you are.
...
3.  If you’re looking for an RA post, ask around too (again, see [here](#fn_jdi) if you're worried about emailing academics). You should also keep an eye on places like Twitter, jobs.ac.uk etc.
...
6.  Try formalizing your experiment ideas. Formulate some hypotheses and show you would test them. Show your supervisor if you want to. This will be good practice and shows you can think through the scientific process.
...
3.  funding for your own proposed PhD project. This is an application for you, your proposed project and your supervisor for some of the money kept in university pots.

Funding can come from charities (such as the Wellcome Trust), industry partnerships, UK Research and Innovation (overarching body containing MRC etc) or you can self-fund your research.

You can apply for a mix of all of these, and consider all options you apply to (and don't apply to anything you wouldn't consider). The following pages contain a rough summary of my experience with these types of applications.

Initial tips for ANY application:

1.  Make sure you understand the application procedure. I very nearly missed out on being considered for funding this year having misunderstood when my references needed to be in. Do not have the world’s best application and then not get it funded because you missed the deadline.
...
Freedom is competitive. You are also focussing on trying to sell yourself, as opposed to a particular project/supervisory team.
...
5.  Do not forget that you have to live there. If you have seen a great PhD in Leeds, but don’t want to live north of Birmingham, you might struggle. Don’t throw yourself at a project if you’re not sure that the whole package (life too!) works for you.
...
1.  PhD applications take a long time initially. They just do. Add time on to whatever time frame you’re thinking. You can finish early but not late. You should allow enough time to go back and check over it a few times, but not so much time that you’re over thinking about every detail. Once you’ve written one, it's like riding a bike.
2.  Applying with a supervisor has a lot of advantages. It is much clearer what should be included in the application, your supervisor can help direct it (listen to what they have to say), and importantly if you’re carrying on work you’re already doing – no one knows the project like you do. This gives you the opportunity to explain it as well as possible.
...
See [here](#fn_prop_struc) for an example proposal structure.

Full disclosure: most of my proposals went to Oxbridge and funding bodies/charities. I think the tips should also be applicable for other universities.
...
After the doom and gloom on the previous page, I wanted to finish on something more empowering. It can be difficult when starting out in academia to make your own life easier because you're worried about how it might come across to your seniors. I've come up with a few things which you should know from the beginning that it is okay to do. It's okay to:
...
Overall, applying for PhD's can be extremely rewarding process. You'll pick up lots of skills useful for applying for other grants, you'll start to be able to explain your research goals and aims more clearly, and hopefully you'll get a PhD. I hope this post sheds some light on the process.
...
For example, I can't code for toffee and I went from basically using MATLAB as a calculator to writing an experiment within a couple of weeks.

Go back to [research experience](#importance).
...
1.  How busy is the supervisor? How likely are you to see them and for how long? This doesn’t have to be a good or a bad thing, but it is worth knowing. This may not be an issue if you’re someone who is self-directed, but may not work for you if you need a lots of input.
...
Go back to [research experience](#importance), or [proposals](#prop_proj)
